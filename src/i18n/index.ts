...
const messages = {
  tr: {
    ...
    landing: {
      ...
      manualCardTitle: "Manuel Mod",
      inviteCardDescriptionLine1: "Katılımcılar formu doldursun,",
      inviteCardDescriptionLine2: "belirlediğin tarihte {automatic} çekilsin veya sen {oneClick} başlat!",
      inviteCardButton: "Üye Ol & Başla",
      inviteCardTitle: "Davet Mod",
      inviteCardBadge: "Özel ★",
      inviteCardBadgeFree: "Ücretsiz",
      inviteCardFooter: "★ Yeni Yıla Özel Davet Modu!",
      highlightAutomatic: "otomatik",
      highlightOneClick: "tek tıkla",
      manualCardBadge: "Ücretsiz",
      footnote:
  ...
  en: {
    ...
    landing: {
      ...
      manualCardTitle: "Manual Mode",
      inviteCardDescriptionLine1: "Let participants join via form,",
      inviteCardDescriptionLine2: "run it on your chosen date {automatic} or with {oneClick}.",
      inviteCardButton: "Register & Start",
      inviteCardTitle: "Invite Mode",
      inviteCardBadge: "Special ★",
      inviteCardBadgeFree: "Free",
      inviteCardFooter: "★ New Year Special Invite Mode!",
      highlightAutomatic: "automatically",
      highlightOneClick: "one click",
      manualCardBadge: "Free",
      footnote:
