...
const messages = {
  tr: {
    ...
    landing: {
      ...
      title: "Santa's Draw",
      subtitlePrefix: "Yılbaşı çekilişini ister",
      subtitleManualHighlight: "şimdi başlat",
      subtitleMiddle: "ister",
      subtitleInviteHighlight: "formla katılımcı topla",
      manualCardDescriptionLine1: "Katılımcıları el ile ekle,",
      manualCardDescriptionLine2: "şimdi hemen çekilişini başlat!",
      manualCardButton: "Başla",
      inviteCardDescriptionLine1: "Katılımcılar form ile katılsın,",
      inviteCardDescriptionLine2: "belirlediğin tarihte ya da tek tıkla çekilsin.",
    ...
    draw: {
      ...
      headingSubtitle: "Katılımcılarını ekle, kuralları belirle ve çekilişini başlat. 🎁",
      ...
      drawDateOptionalHint: "Tarih eklemezsen çekilişi istediğin zaman başlatabilirsin.",
    ...
    alerts: {
      ...
      manualMinimumParticipants: "Çekiliş için en az 3 katılımcı gereklidir!",
    ...
    join: {
      ...
      subheading: "Bilgilerinizi doldurarak çekilişe katılabilirsiniz",
      submit: "Kayıt Ol",
      submitting: "Kaydediliyor…",
      successTitle: "Tebrikler!",
      successMessage: "Çekilişe başarıyla katıldınız! 🎁",
    ...
    auth: {
      ...
      loginSubtitle: "Santa's Draw hesabına giriş yap ve çekilişlerini yönet 🎄",
      registerTitle: "Kayıt Ol",
      registerSubtitle: "Hesabını oluştur ve çekilişlerini yönetmeye başla 🎁",
      emailLabel: "Email",
      passwordLabel: "Şifre",
      ...
      loginLink: "Giriş yap",
      celebration: "🎁 Çekiliş macerası başlıyor!",
      logout: "Çıkış Yap",
      errors: {
  ...
  en: {
    ...
    landing: {
      ...
      subtitleMiddle: "or",
      subtitleInviteHighlight: "collect participants with a form",
    ...
    draw: {
      ...
      headingSubtitle: "Add participants, set the rules, and start the fun. 🎁",
    ...
    alerts: {
      ...
      manualMinimumParticipants: "You need at least 3 participants to run the draw!",
    ...
    join: {
      ...
      subheading: "Fill in your details to join the fun",
      submit: "Join",
      submitting: "Submitting…",
      successTitle: "Congrats!",
      successMessage: "You successfully joined the draw! 🎁",
